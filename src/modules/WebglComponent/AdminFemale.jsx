...
import BGSrc1 from '../../assests/images/BGSrc.jpeg';
import $ from 'jquery';
...
class AdminFemale extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      mobile: false,
...
componentDidMount(){
    ...
    var cloudTexture = new THREE.TextureLoader().load(BGSrc1);
    ...
    for (var i = 0; i<mapsArray.length; i++) {
        this.mapOutside[i] = new THREE.TextureLoader().load( this.props.fabImage );
        this.mapOutside[i].wrapS = THREE.RepeatWrapping;
        this.mapOutside[i].wrapT = THREE.RepeatWrapping;
        this.mapOutside[i].repeat.set( this.props.tilex, this.props.tiley );
