...
export const ContrastMobile = ({ setNewValue, styleJson, allFabs,splitStyleName  }) => {
  useEffect(() => {
    console.log(styleJson);
  }, [])
  return (
    <div className="contrastmobile-section">
      {/* Contrast Mobile */}
      <div className="scroll-section-contrast py-3">
        ...
        {/* colllar */}
        { styleJson.submenu.length !== 0 ? (
            <>
              { styleJson && styleJson.submenu && styleJson.submenu.map((style, index) => {

          return <div className="color_cullar w-full">
          <div className="heading-font">
            <h2>{ splitStyleName(style.name) }</h2>
          </div>
          <div className="collar-imgs my-3">
            <div className="collar-specfic flex flex-col">
              {/* <div> */}
